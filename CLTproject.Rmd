...
For a sample size of 9. According to the Central Limit There, the graph shows that the mean gets closer ed 50 1f rounded up, while standard deviation is decreasing because according to CLT theorem it is expected to decrease because the sample standard deviation was 42.0198675541614 and when increasing the sample size in this case 9, so when dividing the simple standard deviation by square root of 9 it will be 14.0066225 which is approximately close to the result I got which round up er down to 14 showing that the graph is getting more symmetrical.
